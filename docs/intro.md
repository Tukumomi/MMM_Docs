...
:::
<details>
    <summary>**アバター追加対応依頼について**</summary>

    各アバター対応依頼については二通りの方法があります。  
    **①リクエストのみ**  
        ┣Twitter(X)やBoothにどのアバターに対応して欲しいかメッセージを送って下さい。  
        ┗アバター規約や需要や予算を加味して追加できそうなら追加をします。(こちらは余裕がある時の対応になります。)  
          
    **②リクエスト&ギフト**  
        ┣Twitter(X)やBoothのDMにどのアバターに対応して欲しいか&アバターギフトでの対応依頼との旨をお伝えください。  
        ┣こちらでアバター規約等を確認し、追加できそうならお伝えいたしますのでその後に対応アバターのギフトをお送りください。  
